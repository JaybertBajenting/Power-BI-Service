...
namespace Power_BI_Service.Workspaces
{
    ...
    public class Workspace
    {
            ...
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "workspace/create")] HttpRequestData req)
        {
            ...
            var requestBody = await JsonSerializer.DeserializeAsync<CreateWorkspaceRequest>(req.Body);
        ...
        private static async Task<string> AddUserToWorkspaceAsync(string accessToken, string workspaceId, string userEmail, string accessRight)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                var requestBody = new
                {
                    ...
                    groupUserAccessRight = accessRight, // Example: Admin, Contributor, Member, Viewer
                    principalType = "User"
                };
